<form action="" method="post" id="entryForm" class="p-0">
    ...
    <div class="modal-footer flex-wrap">
        ...
        <div class="form-group">
            ...
            <button type="button" name="search_payment" id="search_payment" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#entryListModal"><i class="fa fa-search"></i> Segundo pago</button>
